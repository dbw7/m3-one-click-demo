...
curl https://raw.githubusercontent.com/dbw7/m3-one-click-demo/main/suse-edge-main/equinix-playbook-main.yaml > ~/ansible/equinix-playbook.yaml

#put the extra vars file in the ansible directory temporarily
curl https://raw.githubusercontent.com/dbw7/m3-one-click-demo/main/suse-edge-main/extra_vars_main.yml > ~/ansible/extra_vars.yml
