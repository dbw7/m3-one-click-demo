...
curl https://raw.githubusercontent.com/dbw7/m3-one-click-demo/main/debug-non-sylva/equinix-playbook-debug1.yaml > ~/ansible/equinix-playbook.yaml

#put the extra vars file in the ansible directory temporarily
curl https://raw.githubusercontent.com/dbw7/m3-one-click-demo/main/debug-non-sylva/extra_vars_debug1.yml > ~/ansible/extra_vars.yml
